Task for final report: DUE DATE: 04.03
...
For me required to optimize the chord, twist and tip speed
Assumptions for Coaxial Rotors
Fully developed slipstream (stream funnel)
Inner area in slipstream is FULLY in slipstream, outside of slipstream undisturbed inflow
Plot inflow speed and angle of attack over radial stations on both rotors
Implement optimization of combined rotor
rotors must be able to be different sizes (no hard-coding)